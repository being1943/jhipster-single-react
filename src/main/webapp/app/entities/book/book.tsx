...
export class Book extends React.Component<IBookProps, IBookState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="book-heading">
          <Translate contentKey="jhipsterSingleReactApp.book.home.title">Books</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSingleReactApp.book.home.createLabel">Create new Book</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('title')}>
                  <Translate contentKey="jhipsterSingleReactApp.book.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('description')}>
                  <Translate contentKey="jhipsterSingleReactApp.book.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('publicationDate')}>
                  <Translate contentKey="jhipsterSingleReactApp.book.publicationDate">Publication Date</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('price')}>
                  <Translate contentKey="jhipsterSingleReactApp.book.price">Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterSingleReactApp.book.author">Author</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {bookList.map((book, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{book.price}</td>
                  <td>{book.authorId ? <Link to={`author/${book.authorId}`}>{book.authorId}</Link> : ''}</td>
