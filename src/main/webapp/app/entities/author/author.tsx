    ...
    return (
      <div>
        <h2 id="author-heading">
          <Translate contentKey="jhipsterSingleReactApp.author.home.title">Authors</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSingleReactApp.author.home.createLabel">Create new Author</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="jhipsterSingleReactApp.author.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('birthDate')}>
                    <Translate contentKey="jhipsterSingleReactApp.author.birthDate">Birth Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
